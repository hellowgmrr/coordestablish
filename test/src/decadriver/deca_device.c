...
int dwt_initialise(uint16 config)
{
    ...
    */
        ...
        gpio_mode |= GPIO_PIN5_EXTTXE;
        dwt_write32bitoffsetreg(GPIO_CTRL_ID, GPIO_MODE_OFFSET, gpio_mode);

		#define DIS_STXP 0x00040000UL
		#define POWER_CONTROL 0x08080808UL
        uint32 dis_stxp;
        dis_stxp = dwt_read32bitoffsetreg(0x04,0);
        dis_stxp = dis_stxp | DIS_STXP;
        dwt_write32bitoffsetreg(0x04, 0, dis_stxp);
        dwt_write32bitoffsetreg(0x1E, 0, POWER_CONTROL);
